            ...
            <StaggerContainer className="grid md:grid-cols-3 gap-0 mb-12">
              ...
              >
                <Image
                  ...
                  alt="Sports massage therapy at Keystone Sports Therapy clinic, Grantham"
              ...
              >
                <Image
                  ...
                  alt="One-to-one personal training session at Keystone Sports Therapy, Grantham"
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                      ...
                      >
                        <Image
                          ...
                          alt="Blue Light Card — discount for NHS workers, emergency services, and key workers"
                          width={imageDimensions.blueLightCard.width}
                          height={imageDimensions.blueLightCard.height}
                          sizes="(max-width: 768px) 80vw, 280px"
                          loading="lazy"
                          className="w-full max-w-xs mx-auto md:mx-0 h-auto rounded-lg"
                        />
                      </motion.div>
                  ...
                  {[
                    {
                      ...
                      alt: "Sports massage therapy for injury recovery at Keystone Sports Therapy, Grantham",
                    ...
                    },
                    {
                      ...
                      alt: "Personal training programmes tailored to individual fitness goals in Grantham",
                    ...
                    },
                    {
                      ...
                      alt: "Reformer Pilates on Align equipment at Keystone Sports Therapy, Grantham",
                    ...
                    },
                    {
                      ...
                      alt: "Nutrition consultation and meal planning at Keystone Sports Therapy, Grantham",
                    ...
                    },
                    {
                      ...
                      alt: "Vitamin B12 injections for energy and wellness at Keystone Sports Therapy, Grantham",
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    <Image
                      src={images.nutritionAdvice}
                      alt="Nutrition consultation at Keystone Sports Therapy clinic, Grantham"
